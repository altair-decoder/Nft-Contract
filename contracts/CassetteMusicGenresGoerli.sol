...
contract CassetteMusicGenresGoerli is ERC721, Ownable, IERC2981 {
    ...
    constructor() ERC721("CassetteMusicGenresGoerli", "CTGG") {}
    ...
    function airdropMint(address[] memory _recipients, uint256 _amount) public onlyOwner {
        // if metadata token started from 1, change j = 1 on looping
